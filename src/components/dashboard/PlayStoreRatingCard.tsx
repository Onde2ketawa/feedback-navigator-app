...
import { usePlayStoreScraper } from '@/hooks/usePlayStoreScraper';
import { Badge } from '@/components/ui/badge';

export function PlayStoreRatingCard() {
  const { scrapePlayStore, scrapedData, isLoading } = usePlayStoreScraper();

  const handleScrape = () => {
    scrapePlayStore('linebank');
  };
        ...
        {scrapedData ? (
          <div className="space-y-3">
            ...
            <Button
              ...
              onClick={() => window.open('https://play.google.com/store/search?q=linebank&c=apps&hl=en', '_blank')}
            >
